...
class Admin_Layout_List extends Libraries\WP_List_Table
{
    ...
    public function __construct($plugin_text_domain)
    {
        ...
        $this->count_trashed = database::loadColumn('SELECT COUNT(id) FROM #__customtables_layouts WHERE published=-2')[0];
    ...
    {
        /*
         * Note: Layout bulk_actions can be identified by checking $_REQUEST['action'] and $_REQUEST['action2']
         *
    ...
    {
        // Assuming $_POST['layout'] contains the selected items
