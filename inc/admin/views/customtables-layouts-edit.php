        ...
        <form method="post" name="createlayout" id="createlayout" class="validate" novalidate="novalidate">
            ...
            <h1 id="add-new-user">
                ...
                <div style="display: inline-block;margin-left:20px;"><?php
					$buttonText = ($this->admin_layout_edit->layoutId == 0) ? __('Save New Layout', 'customtables') : __('Save Layout', 'customtables');
            ...
            <!-- Submit Button -->
			<?php
			$buttonText = ($this->admin_layout_edit->layoutId == 0) ? __('Add New Layout', 'customtables') : __('Save Layout', 'customtables');
