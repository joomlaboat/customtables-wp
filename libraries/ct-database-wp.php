...
class MySQLWhereClause
{
	...
	public function addCondition($fieldName, $fieldValue, $operator = '=', $sanitized = false, ?string $join_realtablename = null, ?string $join_real_id_field_name = null, ?string $join_real_field_name = null): void
	{
		global $wpdb;
	...
	public function addOrCondition($fieldName, $fieldValue, $operator = '=', $sanitized = false, ?string $join_realtablename = null, ?string $join_real_id_field_name = null, ?string $join_real_field_name = null): void
	{
		global $wpdb;
		$operator = strtoupper($operator);
...
class database
{
	                                      ...
	                                      string  $groupBy = null, bool $returnQueryString = false, ?string $innerJoin = null)
	{
		...
		if (!empty($innerJoin))
			$query_safe .= ' INNER JOIN ' . $innerJoin;

		$query_safe .= ($whereString != '' ? ' WHERE ' . $whereString : '')
	...
	public static function loadAssocList(string  $table, array $selects, MySQLWhereClause $whereClause, ?string $order = null,
	                                     ...
	                                     ?int    $limitStart = null, string $groupBy = null, bool $returnQueryString = false, ?string $innerJoin = null): ?array
	{
