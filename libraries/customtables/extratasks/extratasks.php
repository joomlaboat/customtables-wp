...
class extraTasks
{
    public static function prepareJS()
    {
        ...
        $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/extratasks.js"></script>');
        $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/modal.js"></script>');
        $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/base64.js"></script>');
        $document->addCustomTag('<link href="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'css/modal.css" rel="stylesheet">');
