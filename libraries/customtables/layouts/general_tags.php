...
class Twig_Url_Tags
{
	...
	function root(): ?string
	{
		if (!$this->ct->Env->advancedTagProcessor) {
			...
			common::enqueueMessage('Warning: The {{ url.root }} ' . __("Available in PRO Version", "customtables"));
			return null;
		}
	...
	function getstringandencode($param, $default = ''): ?string
	{
		if ($this->ct->Env->advancedTagProcessor and class_exists('CustomTables\ctProHelpers')) {
			...
			common::enqueueMessage('Warning: The {{ url.getstringandencode() }} ' . __("Available in PRO Version", "customtables"));
			return null;
		}
	}
	...
	function getstringanddecode($param, $default = ''): ?string
	{
		if ($this->ct->Env->advancedTagProcessor and class_exists('CustomTables\ctProHelpers')) {
			...
			common::enqueueMessage('Warning: The {{ url.getstringanddecode() }} ' . __("Available in PRO Version", "customtables"));
			return null;
		}
	}
	...
	{
		if (!$this->ct->Env->advancedTagProcessor) {
			common::enqueueMessage('Warning: The {{ url.server }} ' . __("Available in PRO Version", "customtables"));
			return null;
		}
