...
class Twig_URL_Tags
{
	...
	function root(): ?string
	{
		if (!$this->ct->Env->advancedTagProcessor)
			throw new Exception('Warning: The {{ url.root }} ' . esc_html__("Available in PRO Version", "customtables"));
	...
	function getstringandencode($param, $default = ''): ?string
	{
		if ($this->ct->Env->advancedTagProcessor and class_exists('CustomTables\ctProHelpers'))
			...
			throw new Exception('Warning: The {{ url.getstringandencode() }} ' . esc_html__("Available in PRO Version", "customtables"));
	}
	...
	{
		if (!$this->ct->Env->advancedTagProcessor)
			throw new Exception('Warning: The {{ url.server }} ' . esc_html__("Available in PRO Version", "customtables"));
