...
if (defined('_JEXEC')) {
    ...
    $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/ajax.js"></script>');

    $version_object = new Version;
    $version = (int)$version_object->getShortVersion();

    $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/typeparams_common.js"></script>');

    if ($version < 4)
        $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/typeparams.js"></script>');
    else
        $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/typeparams_j4.js"></script>');

    $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/layoutwizard.js"></script>');
    $document->addCustomTag('<script src="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'js/layouteditor.js"></script>');
    $document->addCustomTag('<link href="' . JCUSTOMTABLES_MEDIA_WEBPATH . 'css/layouteditor.css" rel="stylesheet">');
